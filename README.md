...
A camera that can be moved with the mouse
...
### Linux / CLI
```bash
clone-gd-addon https://github.com/ChillCube/MouseMovableCamera.git
```

## Documentation
https://github.com/ChillCube/MouseMovableCamera/blob/main/DOCUMENTATION.md

## Deinstallation
Use the CC Tools panel in Godot, or run:
```bash
remove-gd-addon MouseMovableCamera
```
